...
"""
svm
accuracy 0.9050567595459237
precision [0.89442231 0.91648822]
recall [0.92008197 0.88981289]

knn
accuracy 0.7987616099071208
precision [0.73743922 0.90625   ]
recall [0.93237705 0.66320166]

adaboost
accuracy 0.8864809081527347
precision [0.87351779 0.90064795]
recall [0.9057377  0.86694387]
...
# %%
pd.DataFrame(aada).to_csv("ada_output.csv")

# %%
clf = AdaBoostClassifier(n_estimators=113, random_state=0)
clf.fit(tr_X.reshape((len(tr_X), 68*2)), list(zip(*tr_Y))[0])
clf_pred = clf.predict(te_X.reshape((len(te_X), 68*2)))

# %%
printOutput(clf_pred)

...
def extract_features_labels():
    ...
    labels = (np.array(all_labels) + 1)/2
    return landmark_features, labels


#this function simply print the evaluation metrics for a model
...
def a1():
    ...
    #cross-validation to find the best value for knn and adaboost
    """
    aknn = []
    ...
    ada = AdaBoostClassifier(n_estimators=113, random_state=0)
